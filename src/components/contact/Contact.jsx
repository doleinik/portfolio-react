                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <a href="mailto:doleinika@gmail.com" className="contact__button">
                                Write me
                        ...
                        <div className="contact__card">
                            <i className="bx bxl-telegram contact__cars-icon"></i>

                            <h3 className="contact__card-title">Telegram</h3>
                            <span className="contact__card-data">@doleinik</span>
                        ...
                        <div className="contact__card">
                            <i className='bx bxl-linkedin contact__cars-icon'></i>
